...
// define ChatService
func (is *ChatServer) ChatService(csi pb.Services_ChatServiceServer) error {
...
// receive messages
func receiveFromStream(csi_ pb.Services_ChatServiceServer, clientUniqueCode_ int, errch_ chan error) {
...
// send message
func sendToStream(csi_ pb.Services_ChatServiceServer, clientUniqueCode_ int, errch_ chan error) {
